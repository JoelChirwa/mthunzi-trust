          ...
          <div className="px-8 py-6 bg-gradient-to-r from-teal-500 to-blue-600">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-teal-100 mt-1">Update team member details</p>
              </div>
              <button
                type="button"
              ...
              {formData.image && (
                <div className="mb-3 relative group">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-1/2 transform translate-x-16 bg-red-500 text-white p-1.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity hover:bg-red-600"
                  >
                    <svg
                      className="w-3 h-3"
                      fill="none"
